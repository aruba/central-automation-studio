	...
	return (
		...
		(function(a, b, c) {
						...
						function(e) {
							function f(a, b) {
								...
								a.easing && ((h = a.easing instanceof Array ? a.easing : c.Svg.Easing[a.easing]), delete a.easing),
									...
									b && ((a.fill = 'freeze'), (i[e] = a.from), this.attr(i), (g = c.stripUnit(a.begin || 0)), (a.begin = 'indefinite')),
			...
			(c.xmlNs = { qualifiedName: 'xmlns:ct', prefix: 'ct', uri: 'http://gionkunz.github.com/chartist-js/ct' }),
				(c.Svg = c.Class.extend({ constructor: d, attr: e, elem: f, parent: g, root: h, querySelector: i, querySelectorAll: j, foreignObject: k, text: l, empty: m, remove: n, replace: o, append: p, classes: q, addClass: r, removeClass: s, removeAllClasses: t, height: v, width: w, animate: x })),
				(c.Svg.isSupported = function(a) {
					return b.implementation.hasFeature('http://www.w3.org/TR/SVG11/feature#' + a, '1.1');
				});
			var C = { easeInSine: [0.47, 0, 0.745, 0.715], easeOutSine: [0.39, 0.575, 0.565, 1], easeInOutSine: [0.445, 0.05, 0.55, 0.95], easeInQuad: [0.55, 0.085, 0.68, 0.53], easeOutQuad: [0.25, 0.46, 0.45, 0.94], easeInOutQuad: [0.455, 0.03, 0.515, 0.955], easeInCubic: [0.55, 0.055, 0.675, 0.19], easeOutCubic: [0.215, 0.61, 0.355, 1], easeInOutCubic: [0.645, 0.045, 0.355, 1], easeInQuart: [0.895, 0.03, 0.685, 0.22], easeOutQuart: [0.165, 0.84, 0.44, 1], easeInOutQuart: [0.77, 0, 0.175, 1], easeInQuint: [0.755, 0.05, 0.855, 0.06], easeOutQuint: [0.23, 1, 0.32, 1], easeInOutQuint: [0.86, 0, 0.07, 1], easeInExpo: [0.95, 0.05, 0.795, 0.035], easeOutExpo: [0.19, 1, 0.22, 1], easeInOutExpo: [1, 0, 0, 1], easeInCirc: [0.6, 0.04, 0.98, 0.335], easeOutCirc: [0.075, 0.82, 0.165, 1], easeInOutCirc: [0.785, 0.135, 0.15, 0.86], easeInBack: [0.6, -0.28, 0.735, 0.045], easeOutBack: [0.175, 0.885, 0.32, 1.275], easeInOutBack: [0.68, -0.55, 0.265, 1.55] };
		...
		(function(a, b, c) {
			...
			function d(a) {
				...
				(d = void 0 === a.axisX.type ? new c.StepAxis(c.Axis.units.x, b, j, c.extend({}, a.axisX, { ticks: b.raw.labels, stretch: a.fullWidth })) : a.axisX.type.call(c, c.Axis.units.x, b, j, a.axisX)),
					(e = void 0 === a.axisY.type ? new c.AutoScaleAxis(c.Axis.units.y, b, j, c.extend({}, a.axisY, { high: c.isNum(a.high) ? a.high : a.axisY.high, low: c.isNum(a.low) ? a.low : a.axisY.low })) : a.axisY.type.call(c, c.Axis.units.y, b, j, a.axisY)),
								...
								o.splitByCommand('M')
									...
									.forEach(
										function(h) {
											...
											this.eventEmitter.emit('draw', { type: 'area', values: b.normalized[g], path: h.clone(), series: f, seriesIndex: g, axisX: d, axisY: e, chartRect: j, index: g, group: i, element: k });
										}.bind(this)
									);
							}
						}.bind(this)
				...
				l.createGridAndLabels(e, h, this.supportsForeignObject, a, this.eventEmitter),
					...
					d.raw.series.forEach(
						function(b, e) {
							...
							(f = a.distributeSeries && !a.stackBars ? l.axisLength / d.normalized.length / 2 : a.distributeSeries && a.stackBars ? l.axisLength / 2 : l.axisLength / d.normalized[e].length / 2),
								(h = g.elem('g')),
								h.attr({ 'series-name': b.name, meta: c.serialize(b.meta) }, c.xmlNs.uri),
									...
									function(g, k) {
										...
										if (((u = a.distributeSeries && !a.stackBars ? e : a.distributeSeries && a.stackBars ? 0 : k), (r = a.horizontalBars ? { x: o.x1 + j.projectValue(g && g.x ? g.x : 0, k, d.normalized[e]), y: o.y1 - l.projectValue(g && g.y ? g.y : 0, u, d.normalized[e]) } : { x: o.x1 + l.projectValue(g && g.x ? g.x : 0, u, d.normalized[e]), y: o.y1 - j.projectValue(g && g.y ? g.y : 0, k, d.normalized[e]) }), l instanceof c.StepAxis && (l.options.stretch || (r[l.units.pos] += f * (a.horizontalBars ? -1 : 1)), (r[l.units.pos] += a.stackBars || a.distributeSeries ? 0 : i * a.seriesBarDistance * (a.horizontalBars ? -1 : 1))), (t = q[k] || p), (q[k] = t - (p - r[l.counterUnits.pos])), void 0 !== g)) {
											...
											(v[l.units.pos + '1'] = r[l.units.pos]),
												...
												(v[l.counterUnits.pos + '2'] = a.stackBars ? q[k] : r[l.counterUnits.pos]),
